...
#ifndef CONFIG_KERNEL_CUSTOM_P3592        //add by longcheer_liml_2016_12_15
...
// add end
	...
	//printk("~~liml_chg func=%s,line=%d,chip->usb_max_current_ma=%d,i=%d\n",__func__,__LINE__,chip->usb_max_current_ma,i);
...
#if defined(CONFIG_KERNEL_CUSTOM_P3592)//add by longcheer_liml_2016_12_15
